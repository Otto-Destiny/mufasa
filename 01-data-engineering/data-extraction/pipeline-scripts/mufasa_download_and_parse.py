"""Converted from mufasa-download-and-parse.ipynb.
...
ENVIRONMENT = "kaggle"          # "local" | "kaggle" | "colab" | "auto"
...
KAGGLE_INPUT_DATASET = "/kaggle/input/datasets/destinyotto/mufasa-download-and-parse-data"   # mounted folder name under /kaggle/input
...
def parse_one(item):
        ...
        try:
            ...
            try:
                ...
                return {"paper_id": row["paper_id"], "parse_status": "parse_failed",
                        ...
                        "parser_name": parser_used, "parser_version": fitz.VersionBind,
    ...
    structured = {
        ...
        "parser_version": PARSER_VERSION if parser_used == PARSER_NAME else fitz.VersionBind,
